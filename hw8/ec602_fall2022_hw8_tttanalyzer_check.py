...
VERSION, CURL_GRADING_VER = (3,0), (3, 7)
...
class TTTAnalyzerTestCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.Points = {"all":25,"tally":15,
               'tttr_string':40,'tttr_vector':20}
...
testcases={
'hw8_tttanalyzer.cpp':TTTAnalyzerTestCase,
}
programs = ['hw8_tttanalyzer.cpp']
tested_programs = {x:x for x in programs}

if __name__ == '__main__':
    print('TTT Analyzer (HW8) Checker Version {0}.{1}\n'.format(*VERSION))
    g={}
